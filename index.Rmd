...
* PC de altas prestaciones + Python + OpenDroneMap + GDAL + QGIS + R

![](img/logos.jpg){width=75%}

## Método

* Se realizaron __3 vuelos con drone+cámara__, entre junio y julio de 2019 y una repetición parcial en julio de 2021, en los que se tomaron >500 fotografías.
...
* Se generaron tanto __ortoimagen y modelo digital de superficie__ (DSM), pero en la clasificación sólo se usó la primera
